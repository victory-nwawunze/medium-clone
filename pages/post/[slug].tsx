...
function Post({ post }: Props) {
    // console.log("All slug Post =========>", post)
    // console.log("All slug Post MainImage =========>", post.mainImage)
    ...
    return (
        <main>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col p-5 max-w-2xl mx-auto mb-10">
                        ...
                        <label className="block mb-5">
                            ...
                            <input
                                ...
                                className="shadow rounded py-2 border px-3 form-input mt-1 block w-full ring-yellow-500  outline-none focus:ring"
                                type="text"
                        ...
                        <label className="block mb-5">
                            ...
                            <textarea
                                ...
                                className="shadow border py-2 rounded px-3 form-textarea mt-1 block w-full ring-yellow-500 outline-none focus:ring"
            ...
            <div className="flex p-10 my-10 max-w-2xl mx-auto flex-col shadow-yellow-500 shadow space-y-2">
